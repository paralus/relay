...
// CASE 5 /api/v1/pods
// CASE 6 /api/v1/namespaces/paralus-system
// CASE 7 /api/v1/namespaces/paralus-system/configmaps/relay-agent-config
...
func TestURL(t *testing.T) {
	...
	if h, params, _ := r.Lookup("GET", "/api/v1/namespaces/paralus-system/configmaps/relay-agent-config"); h != nil {
		t.Log(params)
	} else {
		t.Error("expected match")
		return
